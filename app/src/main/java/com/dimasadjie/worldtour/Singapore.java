...
public class Singapore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = findViewById(R.id.timesingapore);
        url = "https://worldtimeapi.org/api/timezone/Asia/Singapore";
        fetchData();
    }
    ...
    public void back(View view){
        Intent intent = new Intent(Singapore.this, MainMenus.class);
        startActivity(intent);
    }
    public void singaporemaps(View view){
        Intent intent = new Intent(Singapore.this, Singaporemaps.class);
        startActivity(intent);
    }
}