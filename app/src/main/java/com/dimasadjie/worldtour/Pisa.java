...
public class Pisa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = findViewById(R.id.timeitalia);
    ...
    public void back(View view){
        Intent intent = new Intent(Pisa.this, MainMenus.class);
        startActivity(intent);
    }
    public void pisamaps(View view){
        Intent intent = new Intent(Pisa.this, Pisamaps.class);
        startActivity(intent);
    }
}