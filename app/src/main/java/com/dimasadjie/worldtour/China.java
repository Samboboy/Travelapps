...
public class China extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = findViewById(R.id.timechina);
    ...
    public void back(View view){
        Intent intent = new Intent(China.this, MainMenus.class);
        startActivity(intent);
    }
    public void chinamaps(View view){
        Intent intent = new Intent(China.this, Chinamaps.class);
        startActivity(intent);
    }
}