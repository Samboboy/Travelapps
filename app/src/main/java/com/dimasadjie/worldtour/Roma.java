...
public class Roma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = findViewById(R.id.timeroma);
    ...
    public void back(View view){
        Intent intent = new Intent(Roma.this, MainMenus.class);
        startActivity(intent);
    }
    public void romamaps(View view){
        Intent intent = new Intent(Roma.this, Romamaps.class);
        startActivity(intent);
    }
}